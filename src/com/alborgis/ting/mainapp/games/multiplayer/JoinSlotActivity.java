...
public class JoinSlotActivity extends Activity {
	...
	public static boolean isVisible = false; // Esta variable va cambiando si el activity está visible o no
	...
	protected void onResume() {
		super.onResume();
		isVisible = true; // Poner que el activity está visible
		checkSession();
		updateView();
	}
	...
	public void onPause() {
		super.onPause();
		isVisible = false; // Poner que el activity está no visible (en background)
	}
