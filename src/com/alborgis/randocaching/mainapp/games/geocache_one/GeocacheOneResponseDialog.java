...
public class GeocacheOneResponseDialog extends Dialog {
	...
	public GeocacheOneResponseDialog(Context context, Activity _act, Application _app, String _title, String _body, String _buttonText, BundleEarned _bundleEarned, int _gullyState, boolean _showRatingBar, String _nidGeocacheGame, GeocacheOneResponseDialogListener _listener) {
		super(context);
		app = (MainApp)_app;
		ctx = context;
		activity = _act;
