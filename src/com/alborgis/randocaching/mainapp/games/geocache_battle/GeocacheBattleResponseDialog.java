package com.alborgis.randocaching.mainapp.games.geocache_battle;
...
public class GeocacheBattleResponseDialog extends Dialog {
	
	public static final int STATE_GULLY_AGOTADOS_INTENTOS	=	1;
	...
	public GeocacheBattleResponseDialog(Context context, Activity _act, Application _app, String _title, String _body, String _buttonText, BundleEarned _bundleEarned, int _gullyState, boolean _showRatingBar, String _nidGeocacheGame, GeocacheOneResponseDialogListener _listener) {
		super(context);
		app = (MainApp)_app;
		ctx = context;
		activity = _act;
	...
	private void inicializarForm(){
		...
		}else if(this.gullyState == STATE_GULLY_AGOTADOS_INTENTOS){
			this.imageViewRespuesta.setImageResource(R.drawable.icono_error_cofre_popup);
			this.imageViewGully.setImageResource(R.drawable.gully_error_popup);
		}
