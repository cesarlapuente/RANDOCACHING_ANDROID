package com.alborgis.randocaching.mainapp.common.map_layer_change;
...
public class CapaBase {
	...
	public Object getMapLayer(){
		...
		if(claseCapaBase != null){
			Milog.d( "En getMapLayer la claseCapaBase no es nula: " + claseCapaBase.getName());
		}else{
			Milog.d( "En getMapLayer la claseCapaBase es nula");
		}
		
		
		if(claseCapaBase == BingMapsLayer.class){
			Milog.d( "La capa es de tipo BING");
			...
			Milog.d( "La capa es de tipo TiledMap");
