package com.alborgis.randocaching.mainapp.common.wikitude;
...
import com.alborgis.randocaching.mainapp.common.wikitude.location.ILocationProvider;
import com.alborgis.randocaching.mainapp.common.wikitude.location.LocationProvider;
		...
		this.sensorAccuracyListener = new SensorAccuracyChangeListener() {
			...
			public void onCompassAccuracyChanged( int accuracy ) {
				...
				if ( accuracy < SensorManager.SENSOR_STATUS_ACCURACY_MEDIUM && BasicArchitectActivity.this != null && !BasicArchitectActivity.this.isFinishing() ) {
					Toast.makeText( BasicArchitectActivity.this, "Accuracy low", Toast.LENGTH_LONG ).show();
				}
			}
		};
